...
function redirect() {
  ...
  window.location.href="./offline/weather.html";
  else
...
function fetchWeatherData() {
  fetch(
    ...
    .then(function (data) {
      ...
      //entering data from api to the website
      ...
      //icon for showing weather as per weather report by api
      ...
      //change to night if the entered country has night currently
